...
We will most likely be using it for any new Apple Dashboard Widgets or small client apps we develop in house.
...
# A testing framework of some sort and *gasp* actual unit tests
